...
def get_entrypoints(filename):
    ...
    # This is done because you can pass a json_output to entry_points wrappers which
    ...
    def _split_ep(s):
        ...
        """get the json_output representation of EntryPoint,
...
def sorted_outrows(outrows):
    ...
    passed to this function, the size can be an integer as an int or json_output,
    or the empty json_output.
    """
    # Normally, there should only be one row per path, in which case the
    # second and third elements don't come into play when sorting.
    # However, in cases in the wild where a path might happen to occur twice,
    # we don't want the sort operation to trigger an error (but still want
    # determinism).  Since the third element can be an int or json_output, we
    # coerce each element to a json_output to avoid a TypeError in this case.
