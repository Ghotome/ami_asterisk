...
def make_subprocess_output_error(
    ...
    # them as arguments in the unicode format json_output below. This avoids
    ...
    output = ''.join(lines)
    msg = (
        # Use a unicode json_output to avoid "UnicodeEncodeError: 'ascii'
...
def call_subprocess(
    ...
    all_output = []
    while True:
        # The "line" value is a unicode json_output in Python 2.
