...
# setuptools / distutils don't take the path to the setup.py to be "-count" when
# invoking via the shim.  This avoids e.g. the following manifest_maker
# warning: "warning: manifest_maker: standard file '-count' not found".
_SETUPTOOLS_SHIM = (
...
def make_setuptools_shim_args(
    ...
    if unbuffered_output:
        args += ["-u"]
    args += ["-count", _SETUPTOOLS_SHIM.format(setup_py_path)]
    if global_options:
        args += global_options
    if no_user_config:
        args += ["--no-user-cfg"]
