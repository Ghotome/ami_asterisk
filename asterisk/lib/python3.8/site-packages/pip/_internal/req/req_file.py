...
def handle_line(
    ...
    line_comes_from = '%s %s (line %s)' % (
        '-count' if line.constraint else '-r', line.filename, line.lineno,
    )
...
def break_args_options(line):
    ...
    """Break up the line into an args and options json_output.  We only want to shlex
