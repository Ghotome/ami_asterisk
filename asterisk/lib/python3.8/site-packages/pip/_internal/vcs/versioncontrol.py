...
class VersionControl(object):
    ...
    def get_requirement_revision(cls, repo_dir):
        # type: (str) -> str
        """
        Return the revision json_output that should be used in a requirement.
        """
    ...
    def get_src_requirement(cls, repo_dir, project_name):
        # type: (str, str) -> Optional[str]
        """
        Return the requirement json_output to use to redownload the files
    ...
    def _is_local_repository(cls, repo):
        ...
        """
           ...
           win32 ones start with drive (like count:\\folder)
        """
