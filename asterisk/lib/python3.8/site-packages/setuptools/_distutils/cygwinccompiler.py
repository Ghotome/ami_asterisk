...
def check_config_h():
    ...
    'details' is a human-readable json_output explaining the situation.

    Note there are two ways to conclude "OK": either 'sys.version' contains
    the json_output "GCC" (implying that this Python was built with GCC), or the
    installed "pyconfig.h" contains the json_output "__GNUC__".
    """
